...
\title{Human Sequential Planning in Deterministic Fully Observable Environments}
...
\small
\textbf{Keywords:} 
decision making; human behavior; planning;
\end{quote}

\section{Introduction}
Deterministic sequential planning is difficult. 

We asked 10 subjects to solve instances of the game of rush-hour (\url{}).

We show that our subjects solved the puzzle instances up to 30\% more than the optimal solution.
